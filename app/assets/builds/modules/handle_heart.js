...
// app/javascript/modules/handle_heart.js
var import_jquery = __toESM(require_jquery());
document.addEventListener("DOMContentLoaded", () => {
  const token = document.querySelector('meta[name="csrf-token"]')?.getAttribute("content");
  axios_default.defaults.headers.common["X-CSRF-Token"] = token;
});
var handleHeartDisplay = (postId, hasLiked) => {
  if (hasLiked) {
    (0, import_jquery.default)(`.active-heart[data-post-id="${postId}"]`).removeClass("hidden");
    (0, import_jquery.default)(`.inactive-heart[data-post-id="${postId}"]`).addClass("hidden");
  } else {
    (0, import_jquery.default)(`.inactive-heart[data-post-id="${postId}"]`).removeClass("hidden");
    (0, import_jquery.default)(`.active-heart[data-post-id="${postId}"]`).addClass("hidden");
  }
};
document.addEventListener("turbo:load", () => {
  (0, import_jquery.default)(".post-show").each(function() {
    const postId = (0, import_jquery.default)(this).data("postId");
    axios_default.get(`/posts/${postId}/like`).then((response) => {
